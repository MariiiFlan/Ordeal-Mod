...
@Mod("ordeal")
public class OrdealMod {
	public static final Logger LOGGER = LogManager.getLogger(OrdealMod.class);
	public static final String MODID = "ordeal";

	public OrdealMod(IEventBus modEventBus) {
