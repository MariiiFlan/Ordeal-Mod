...
import net.mcreator.ordeal.client.CameraShakeManager;

@EventBusSubscriber
public record CameraShakePayload(float power, int durationTicks) implements CustomPacketPayload {
	public static final CustomPacketPayload.Type<CameraShakePayload> TYPE = new CustomPacketPayload.Type<>(ResourceLocation.fromNamespaceAndPath("ordeal", "camera_shake"));
