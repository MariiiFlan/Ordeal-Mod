...
public record Ability3Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability3Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OrdealMod.MODID, "key_ability_3"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OrdealMod.addNetworkMessage(Ability3Message.TYPE, Ability3Message.STREAM_CODEC, Ability3Message::handleData);
	}
}