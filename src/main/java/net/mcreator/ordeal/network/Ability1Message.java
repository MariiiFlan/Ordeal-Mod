...
public record Ability1Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability1Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OrdealMod.MODID, "key_ability_1"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OrdealMod.addNetworkMessage(Ability1Message.TYPE, Ability1Message.STREAM_CODEC, Ability1Message::handleData);
	}
}