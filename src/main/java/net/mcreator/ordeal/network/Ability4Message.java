...
public record Ability4Message(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<Ability4Message> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OrdealMod.MODID, "key_ability_4"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OrdealMod.addNetworkMessage(Ability4Message.TYPE, Ability4Message.STREAM_CODEC, Ability4Message::handleData);
	}
}